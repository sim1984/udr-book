<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:exsl="http://exslt.org/common" xmlns:xslthl="http://xslthl.sf.net" version="1.0"
  exclude-result-prefixes="exsl xslthl">
  ...
  <xsl:include href="http://docbook.sourceforge.net/release/xsl-ns/current/html/manifest.xsl"/>
